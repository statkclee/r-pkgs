...
In RStudio, staging and committing are done in the same place, the commit window, which you can open by clicking `r bookdown::embed_png("screenshots/git-commit.png", dpi = 220)` or by pressing Ctrl + Alt + m.
